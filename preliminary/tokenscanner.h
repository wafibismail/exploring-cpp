 ...
 * 
 * The use of the TokenScanner class is illustrated in the following code
 ...
 * class are included in as exercises in the text.
 */
 ...
 * 
 * changes this behaviour so that the scanner ignores whitespace characters.
 */
