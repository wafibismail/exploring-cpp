...
#include <iostream>
#include "buffer.h"
#include "foreach.h" // from the Stanford library (not included in repo)
#include "simpio.h" // from the Stanford library (not included in repo)
using namespace std;
 ...
 * ------------------------------------
 * Execute the command specified by line on the editor buffer.
 */
